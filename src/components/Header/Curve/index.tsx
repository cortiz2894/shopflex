...
export default function Curve({active}: Props) {
  ...
  const initialPath = typeof window !== "undefined" 
    ...
    : "M100 0 L200 0 L200 100 L100 100 Q-100 50 100 0";  // Valor predeterminado para evitar el error en SSR.
  ...
  const targetPath = typeof window !== "undefined" 
    ...
    : "M100 0 L200 0 L200 100 L100 100 Q100 50 100 0";  // Valor predeterminado para evitar el error en SSR.
