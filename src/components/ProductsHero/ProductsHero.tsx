...
export default function ProductsHero({ image, title }: ProductsHeroProps) {
  ...
  return (
    <div className="flex gap-3 relative h-[35vh] mb-5 w-full">
      <Image src={image} layout="fill" objectFit="cover" alt={title} className={styles.image} />
        ...
        <div className="h-full flex flex-col items-start justify-end w-full z-10">
          ...
          <ul className={styles.breadcrumb}>
            <li className="hover:underline">
              <LinkTransition href="/">Home</LinkTransition>
            </li>
            <li className="hover:underline">
              <LinkTransition href="/product-list">Products</LinkTransition>
            </li>
            <li>{title}</li>
          </ul>
        </div>
